...
public class CreatureElementStats extends AbstractWidget
{
    ...
    public CreatureElementStats(DrawHelper drawHelper, Placement placement, ICreature creature, boolean descriptions)
    {
    ...
    public void draw(PoseStack poseStack, WidgetState widgetState, boolean mouseInside)
    {
        ...
        elementSets.put("harmony", this.creature.harmonyElements());
        elementSets.put("attack", this.creature.attackElements());
        elementSets.put("resist", this.creature.resistElements());
        elementSets.put("weakness", this.creature.weaknessElements());
