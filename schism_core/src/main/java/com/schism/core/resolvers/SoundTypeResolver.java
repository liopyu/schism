...
{
    private static final SoundTypeResolver INSTANCE = new SoundTypeResolver();

    /**
     * Gets the singleton SoundTypeResolver instance.
     * @return The Sound Type Resolver, a utility for getting sound types from strings.
     */
    public static SoundTypeResolver get()
    {
        return INSTANCE;
    }

    /**
     * Converts a string to a SoundType, the string should be lower_snake_case.
     * @param string The string to get a SoundType for.
     * @return A Minecraft SoundType.
     */
